...
!function(base){
	...
	base.App = base.extend(base.App, {
		...
		resizeApp: function(app, pos){
			...
			*/
			if(app){
				app.style.left = (pos%base.Config.appsPerRow)*(document.body.clientWidth/4)+"px";
				app.style.top = Math.floor(pos/base.Config.appsPerColumn)*pageHeight/4+"px";
				app.style.height = pageHeight/4*0.85 + "px";
				return true;
			}
			return false;
		},
